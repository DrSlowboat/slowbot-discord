...
export async function handleInteraction(interaction, client) {
  ...
  if (interaction.isChatInputCommand() && interaction.commandName === 'guide') {
    const message1 = `**Slowbot: Void Cascade LFG Guide**\nThanks for inviting Slowbot into your server! If you'd like to make use of this cross-server LFG, please take note of these three requests.`;
    ...
    const message5 = `**The Open Source Project:** If you'd like to find out more about how the bot works, track its progress, contribute to it or create your own version, you can find out more about the project here: [GitHub Repository](<https://github.com/DrSlowboat/slowbot-discord>)`;
